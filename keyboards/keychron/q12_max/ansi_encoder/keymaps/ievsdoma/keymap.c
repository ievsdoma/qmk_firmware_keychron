...
#include "rgb/indicators.h"

const uint8_t caps_indicators[] = {41, 59, 60, 77};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_ansi_103(
        FS_CDIR,  KC_HOME,  KC_DEL,  KC_END,   KC_ESC,   KC_F1,     KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,            KC_F7,    KC_F8,       KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_PSCR,  RGB_MOD,
        KC_NUM,   KC_PSLS,  KC_PAST, KC_PMNS,  KC_GRV,   KC_1,      KC_2,     KC_3,     KC_4,     KC_5,     KC_6,             KC_7,     KC_8,        KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  KC_INS,
        KC_P7,    KC_P8,    KC_P9,   KC_PPLS,  KC_TAB,   KC_Q,      KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,             KC_U,     KC_I,        KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_DEL,
        KC_P4,    KC_P5,    KC_P6,             CW_TOGG,  KC_A,      KC_S,     KC_D,     KC_F,     KC_G,     KC_H,             KC_J,     KC_K,        KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,   KC_END,
        KC_P1,    KC_P2,    KC_P3,   KC_PENT,  KC_LSFT,             KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,             KC_N,     KC_M,        KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,
                  KC_P0,    KC_PDOT,           KC_LCTL,  KC_LGUI,   KC_LALT,                                RSFT_T(KC_SPC),   KC_RALT,  MO(WIN_FN),  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [WIN_FN] = LAYOUT_ansi_103(
        KC_MUTE,  QK_BOOT,  EE_CLR,  DB_TOGG,  _______,  KC_BRID,   KC_BRIU,  KC_TASK,  KC_FILE,  RGB_VAD,  RGB_VAI,          KC_MPRV,  KC_MPLY,     KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  _______,  RGB_TOG,
        _______,  _______,  _______, _______,  _______,  BT_HST1,   BT_HST2,  BT_HST3,  P2P4G,    _______,  _______,          _______,  _______,     _______,  _______,  _______,  _______,  _______,  FS_SPI,
        _______,  _______,  _______, _______,  RGB_TOG,  RGB_MOD,   RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,          _______,  _______,     _______,  _______,  _______,  _______,  _______,  FS_PRNS,
        _______,  _______,  _______,           KC_CAPS,  RGB_RMOD,  RGB_VAD,   RGB_HUD,  RGB_SAD,  RGB_SPD, _______,          _______,  _______,     _______,  _______,  _______,            _______,  FS_SPD,
        _______,  _______,  _______, _______,  AS_TOGG,             _______,  _______,  _______,  _______,  BAT_LVL,          NK_TOGG,  _______,     _______,  _______,  _______,  AS_RPT,   AS_UP,
                  _______,  _______,           _______,  _______,   _______,                                _______,                                 _______,  _______,  _______,  _______,  AS_DOWN,  _______ )
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [WIN_BASE] = {ENCODER_CCW_CW(FAST_SCROLL_UP, FAST_SCROLL_DOWN)},
