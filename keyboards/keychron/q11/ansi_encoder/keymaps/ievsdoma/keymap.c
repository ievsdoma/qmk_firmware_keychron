...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_91_ansi(
        FS_CDIR,  KC_ESC,   KC_F1,    KC_F2,         KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,            KC_F9,    KC_F10,   KC_F11,       KC_F12,   KC_PSCR,  RM_TOGG,  KC_MUTE,
        KC_HOME,  KC_GRV,   KC_1,     KC_2,          KC_3,     KC_4,     KC_5,      KC_6,     KC_7,     KC_8,             KC_9,     KC_0,     KC_MINS,      KC_EQL,   KC_BSPC,            KC_INS,
        KC_DEL,   KC_TAB,   KC_Q,     KC_W,          KC_E,     KC_R,     KC_T,      KC_Y,     KC_U,     KC_I,             KC_O,     KC_P,     KC_LBRC,      KC_RBRC,  KC_BSLS,            KC_END,
        KC_PGUP,  CW_TOGG,  KC_A,     KC_S,          KC_D,     KC_F,     KC_G,      KC_H,     KC_J,     KC_K,             KC_L,     KC_SCLN,  KC_QUOT,                KC_ENT,             KC_DEL,
        KC_PGDN,  KC_LSFT,            KC_Z,          KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,             KC_COMM,  KC_DOT,   KC_SLSH,                KC_RSFT,  KC_UP,
        KC_END,   KC_LCTL,  KC_LWIN,  TD(TWO_LAYR),  KC_LALT,            KC_SPC,                        LSFT_T(KC_BSPC),                      KC_RALT,  TD(TWO_LAYR), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_FN] = LAYOUT_91_ansi(
        ...
        _______,  _______,  _______,  _______,     _______,  _______,    _______,   _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,            FS_SPI,
        AS_RPT,   _______,  _______,  _______,     KC_KP_7,  KC_KP_8,    KC_KP_9,   RM_NEXT,  RM_VALU,  RM_HUEU,  RM_SATU,  RM_SPDU,  _______,      _______,  _______,            FS_PRNS,
        AS_UP,    KC_CAPS,  _______,  _______,     KC_KP_4,  KC_KP_5,    KC_KP_6,   RM_PREV,  RM_VALD,  RM_HUED,  RM_SATD,  RM_SPDD,  _______,                _______,            FS_SPD,
        AS_DOWN,  AS_TOGG,            _______,     _______,  KC_KP_1,    KC_KP_2,   KC_KP_3,  KC_NUM,   _______,  _______,  _______,  _______,                _______,  _______,
    ...
    [SYSTEM_CMD] = LAYOUT_91_ansi(
        ...
        DB_TOGG,  _______,  _______,  _______,     _______,  _______,    _______,   _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______,            DB_TOGG,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [WIN_BASE]   = { ENCODER_CCW_CW(FAST_SCROLL_UP, FAST_SCROLL_DOWN), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
    [WIN_FN]     = { ENCODER_CCW_CW(RM_VALD, RM_VALU), ENCODER_CCW_CW(RM_PREV, RM_NEXT) },
    [SYSTEM_CMD] = { ENCODER_CCW_CW(RM_HUED, RM_HUEU), ENCODER_CCW_CW(RM_SPDD, RM_SPDU) },
};
