...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_91_ansi(
        FS_CDIR,  KC_ESC,   KC_F1,    KC_F2,         KC_F3,    KC_F4,    KC_F5,     KC_F6,    KC_F7,    KC_F8,            KC_F9,    KC_F10,   KC_F11,       KC_F12,   KC_PSCR,  RGB_TOG,  KC_MUTE,
    ...
    [WIN_FN] = LAYOUT_91_ansi(
        ...
        AS_RPT,   _______,  _______,  _______,     KC_KP_7,  KC_KP_8,    KC_KP_9,   RGB_MOD,  RGB_VAI,  RGB_HUI,  RGB_SAI,  RGB_SPI,  _______,      _______,  _______,            FS_PRNS,
        AS_UP,    KC_CAPS,  _______,  _______,     KC_KP_4,  KC_KP_5,    KC_KP_6,   RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  _______,                _______,            FS_SPD,
