...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_91_ansi(
        ...
        AS_DOWN,  AS_TOGG,            _______,     _______,  KC_1,       KC_2,      KC_3,     NK_TOGG,  _______,  _______,  _______,  _______,                _______,  _______,
        _______,  _______,  _______,  _______,     _______,              KC_0,                          _______,            _______,  _______,      _______,  _______,  _______,  _______),
